...
abstract class OAuth2 extends CommonModule
{
	 ...
	 */
	public const CLIENT_ID_PATTERN = '^[a-zA-Z0-9\-_]{32}$';
	 ...
	 */
	public const CLIENT_SECRET_PATTERN = '^\S{6,50}$';
	 ...
	 */
	public const REDIRECT_URI_PATTERN = '^(([^:\/?#]+):)?(\/\/([^\/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?$';
	 ...
	 */
	public const ACCESS_TOKEN_PATTERN = '^[a-fA-F0-9]{40}$';

	/**
	 * Pattern for refresh token.
	 */
	public const REFRESH_TOKEN_PATTERN = '^[a-fA-F0-9]{40}$';
	 ...
	 */
	public const AUTHORIZATION_ID_EXPIRES_TIME = 7;
	 ...
	 */
	public const ACCESS_TOKEN_EXPIRES_TIME = 3600;

	/**
	 * Scope pattern.
	 */
	public const SCOPE_PATTERN = '^[a-zA-Z0-9:]+$';
	 ...
	 * HTTP headers.
	 */
	public const HEADER_HTTP_FOUND = 'HTTP/1.1 302 Found';
	public const HEADER_BAD_REQUEST = 'HTTP/1.1 400 Bad Request';
	public const HEADER_UNAUTHORIZED = 'HTTP/1.1 401 Unauthorized';
	 ...
	 */
	public const AUTHORIZATION_ERROR_ACCESS_DENIED = 'access_denied';
	public const AUTHORIZATION_ERROR_INVALID_REQUEST = 'invalid_request';
	public const AUTHORIZATION_ERROR_INVALID_CLIENT = 'invalid_client';
	public const AUTHORIZATION_ERROR_INVALID_GRANT = 'invalid_grant';
	public const AUTHORIZATION_ERROR_INVALID_SCOPE = 'invalid_scope';
	public const AUTHORIZATION_ERROR_SERVER_ERROR = 'server_error';
	public const AUTHORIZATION_ERROR_TEMPORARILY_UNAVAILABLE = 'temporarily_unavailable';
	public const AUTHORIZATION_ERROR_UNAUTHORIZED_CLIENT = 'unauthorized_client';
	public const AUTHORIZATION_ERROR_UNSUPPORTED_RESPONSE_TYPE = 'unsupported_response_type';
	public const AUTHORIZATION_ERROR_UNSUPPORTED_GRANT_TYPE = 'unsupported_grant_type';
	 ...
	 * @return bool true if secret is valid, otherwise false
	 */
	 ...
	 * @return bool true if redirect URI is valid, otherwise false
	 */
	 ...
	 * Validate scopes.
	 *
	 * @param int $scope all scope value
